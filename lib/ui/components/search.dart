...
class _SearchPageState extends State<SearchPage> {
  ...
  void addSearchTerm(String term) {
    ...
    DataBaseManager().saveSearchHistory(_searchHistory);
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: DataBaseManager().getSearchHistory(),
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          _searchHistory = snapshot.data as List<String>;
          filteredSearchHistory = filteredSearchTerms(filter: null);
        }
        return Scaffold(
          body: FloatingSearchBar(
            ...
            body: FloatingSearchBarScrollNotifier(
                child:
                    SongsVerticalListView("search", selectedTerm, null, null)),
